...
namespace NorthShore.Restaurant.EntityFrameworkCore.Repositories
{
    /// <summary>
    ...
    /// </summary>
    /// <typeparam name="TEntity">Entity type</typeparam>
    public abstract class RestaurantRepositoryBase<TEntity> : RestaurantRepositoryBase<TEntity, int>
